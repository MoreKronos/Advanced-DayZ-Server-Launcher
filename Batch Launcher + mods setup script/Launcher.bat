...
start "DayZ Server" "DayZServer_x64.exe" -profiles=profiles -config=server_profile\serverDZ.cfg -port=%serverPort% -cpuCount=%serverCPU% -mod=@mod1;@mod2;@mod3 -dologs -netLog -adminlog -freezecheck
